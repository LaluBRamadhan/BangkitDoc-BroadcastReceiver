...
import com.code.broadcastreceiver.databinding.ActivitySmsReceiverBinding

class SmsReceiverActivity : AppCompatActivity() {

    companion object{
        const val EXTRA_SMS_NO = "extra sms no"
        const val EXTRA_SMS_MESSAGE = "extra sms message"
    }
